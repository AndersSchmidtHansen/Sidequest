...
@section('content')
  {!! Form::model($settings, ['url' => 'admin/update-settings']) !!}
      ...
      {!! Form::panelOpen('Application Settings') !!}
        {!! Form::panelBodyOpen() !!}

          <div class="panel-group">

            {!! Form::accordionOpen('General Settings', false, 'wrench') !!}
              {!! Form::textField('name', 'Application Name', null, ['class' => 'form-control']) !!}
            {!! Form::accordionClose() !!}


            {!! Form::accordionOpen('API Keys', false, 'key') !!}
            ...
            {!! Form::accordionOpen('Notifications & Email', false, 'bell') !!}
            ...
            {!! Form::accordionOpen('Social Media Connections', true, 'share-alt') !!}
            ...
            {!! Form::accordionOpen('Company Details', false, 'building') !!}
